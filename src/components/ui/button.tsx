...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(190,90%,45%)]/50",
  {
    variants: {
      variant: {
        // Primary - Main call-to-action (teal/cyan)
        primary: "bg-[hsl(190,90%,45%)] text-white rounded-xl shadow-soft hover:bg-[hsl(190,90%,40%)] font-medium",
